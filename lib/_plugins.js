 ...
 */
const kg_clean_basic_html_1 = __importDefault(require("@tryghost/kg-clean-basic-html"));
function createParserPlugins(_options = {}) {
    ...
    function _readFigCaptionFromNode(node, payload) {
        ...
        if (figcaption) {
            let cleanHtml = kg_clean_basic_html_1.default(figcaption.innerHTML, options);
    ...
    function mixtapeEmbed(node, builder, { addSection, nodeFinished }) {
        ...
        if (titleElement && titleElement.innerHTML) {
            title = kg_clean_basic_html_1.default(titleElement.innerHTML, options);
        ...
        if (descElement && descElement.innerHTML) {
            description = kg_clean_basic_html_1.default(descElement.innerHTML, options);
        ...
        let publisher = kg_clean_basic_html_1.default(anchorElement.innerHTML, options);
        if (publisher) {
    ...
    function kgHtmlCardToCard(node, builder, { addSection, nodeFinished }) {
        ...
        console.log("--> kgHtmlCardToCard NODE!");
        let html = [];
    ...
    function brToSoftBreakAtom(node, builder, { addMarkerable, nodeFinished }) {
        ...
        console.log("--> brToSoftBreakAtom NODE!");
    ...
    function removeLeadingNewline(node) {
        ...
        console.log("--> removeLeadingNewline NODE!");
    ...
    const kgGalleryCardToCard = (node, builder, { addSection, nodeFinished }) => {
        ...
        console.log("--> kgGalleryCardToCard NODE!");
        let payload = {};
    ...
    function grafGalleryToCard(node, builder, { addSection, nodeFinished }) {
        ...
        console.log("--> grafGalleryToCard NODE!");
        let payload;
    ...
    function figureToImageCard(node, builder, { addSection, nodeFinished }) {
        ...
        console.log("--> figureToImageCard NODE!");
    ...
    function figureIframeToEmbedCard(node, builder, { addSection, nodeFinished }) {
        ...
        console.log("--> figureIframeToEmbedCard NODE!");
    ...
    function figureBlockquoteToEmbedCard(node, builder, { addSection, nodeFinished }) {
        ...
        console.log("--> figureBlockquoteToEmbedCard NODE!");
    ...
    function figureToCodeCard(node, builder, { addSection, nodeFinished }) {
        ...
        console.log("--> figureToCodeCard NODE!");
    ...
    function preCodeToCard(node, builder, { addSection, nodeFinished }) {
        ...
        console.log("--> preCodeToCard NODE!");
        ...
        //     let payload = {code: codeElement.textContent, language: ""};
        //     let preClass = node.getAttribute('class') || '';
    ...
    function fontToHtmlCard(node, builder, { addSection, nodeFinished }) {
        ...
        console.log("--> fontToHtmlCard NODE!");
    ...
    function figureScriptToHtmlCard(node, builder, { addSection, nodeFinished }) {
        ...
        console.log("--> figureScriptToHtmlCard NODE!");
